...
export const getAllJobAction = (type,data=null)=> async dispatch =>{
     ...
     try {
        ...
        if(type === "All"){
            const newData = await axios.get('http://localhost:5000/api/jobs/getAllJob')
...
export const getJobAnotherByIdAction = (id)=> async dispatch =>{
    ...
    try {
        const response = await axios.get(`http://localhost:5000/api/jobs/jobanother/${id}`)
        dispatch({
...
export const getJobSkillByIdAction = (id)=> async dispatch =>{
    ...
    try {
        const response = await axios.get(`http://localhost:5000/api/jobs/jobskill/${id}`)
        dispatch({
...
export const getApplicaByIdAction = (id)=> async dispatch =>{
    ...
    try {
        const response = await axios.get(`http://localhost:5000/api/jobs/application/${id}`)
        dispatch({
...
export const getAppReqStatusByIdAction = (obj)=> async dispatch =>{
    ...
    try {
        const response = await axios.post(`http://localhost:5000/api/jobs/appReqRe`,obj)
        dispatch({
...
export const applyForJobAction = (user)=> async dispatch =>{
    ...
    try {
      const res =  await axios.post("http://localhost:5000/api/jobs/applyjob",user);
      console.log(res)
        dispatch({
...
export const getAlljobPostofUser = (id)=> async dispatch =>{
    ...
    try {
      const response =  await axios.post("http://localhost:5000/api/jobs/getMyjobPost",{id});
...
export const getAllUserByJobIdAction = (id)=> async dispatch =>{
    ...
    try {
      const response =  await axios.post("http://localhost:5000/api/jobs/getUserByjobId",{id});
...
export const getAllJobAppliByuserId = (id)=> async dispatch =>{
    ...
    try {
      const response =  await axios.post("http://localhost:5000/api/jobs/getJobAppliByuserId",{id});
...
export const addSkillForJob = (post)=> async dispatch =>{
    ...
    try {
        const response = await axios.post('http://localhost:5000/api/jobs/addskill',post);
...
export const addOtherInfoForJob = (post)=> async dispatch =>{
    ...
    try {
        const response = await axios.post('http://localhost:5000/api/jobs/addjobinfo',post);
